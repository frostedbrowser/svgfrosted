( () => {
    var e = {
        4322: function(e) {
            ...
            function n(e, n) {
                var i, a, s, o, l = e.split(";").filter(r), c = (i = l.shift(),
                a = "",
                s = "",
                (o = i.split("=")).length > 1 ? (a = o.shift(),
                s = o.join("=")) : s = i,
                {
                    name: a,
                    value: s
            ...
            function i(e, i) {
                ...
                if (e.headers)
                    if ("function" == typeof e.headers.getSetCookie)
                        ...
                        var a = e.headers[Object.keys(e.headers).find(function(e) {
                            return "set-cookie" === e.toLowerCase()
                        })];
                        a || !e.headers.cookie || i.silent || console.warn("Warning: set-cookie-parser appears to have been called on a request object. It is designed to parse Set-Cookie headers from responses, not Cookie headers from requests. Set the option {silent: true} to suppress this warning."),
                        e = a
                    }
                return (Array.isArray(e) || (e = [e]),
                i.map) ? e.filter(r).reduce(function(e, t) {
                    var r = n(t, i);
                    return e[r.name] = r,
                    e
                ...
                for (; o < e.length; ) {
                    ...
                    a = !1; l(); )
                        if ("," === (r = e.charAt(o))) {
                            ...
                            o += 1,
                            l(),
                            i = o; o < e.length && "=" !== (r = e.charAt(o)) && ";" !== r && "," !== r; )
                                o += 1;
                            o < e.length && "=" === e.charAt(o) ? (a = !0,
                            o = i,
        ...
        336: function(e, t, r) {
            ...
            class g {
                ...
                constructor(e) {
                    if (this.global = e,
                    n.pX in e)
                        throw console.error("attempted to initialize a scramjet client, but one is already loaded - this is very bad"),
                        Error();
                    if (d.iswindow) {
                        try {
                    ...
                    d.iswindow ? this.bare = new p.Ay : this.bare = new p.Ay(new Promise(e => {
                    ...
                    this.descriptors = {
                        store: new Proxy({},{
                            get: (e, r) => {
                                ...
                                let n = r.split(".")
                                  , i = n.pop()
                                  , a = n.reduce( (e, t) => e?.[t], this.global);
                                if (!a)
                                    return;
                                let s = t.natives.call("Object.getOwnPropertyDescriptor", null, a, i);
                                return e[r] = s,
                                e[r]
                            }
                        }),
                    ...
                    this.meta = {
                        ...
                        get base() {
                            if (d.iswindow) {
                                const e = t.natives.call("Document.prototype.querySelector", t.global.document, "base");
                                if (e) {
                        ...
                        get topFrameName() {
                            ...
                            if (!r)
                                return null;
                            if (!r.name)
                                return console.error("YOU NEED TO USE `new ScramjetFrame()`! DIRECT IFRAMES WILL NOT WORK"),
                                null;
                            return r.name
                        },
                        get parentFrameName() {
                            ...
                            if (t.global.parent.window == t.global.window)
                                return null;
                ...
                hook() {
                    ...
                    t))
                        !e.enabled || e.enabled(this) ? e.default(this, this.global) : e.disabled && e.disabled(this, this.global)
                }
                get url() {
                    return new URL((0,
                    l.v2)(this.global.location.href))
                }
                set url(e) {
                    e instanceof URL && (e = e.toString());
                    let t = new o.NavigateEvent(e);
                    this.frame && this.frame.dispatchEvent(t),
                    t.defaultPrevented || (this.global.location.href = (0,
                    l.Oy)(t.url, this.meta))
                }
                Proxy(e, t) {
                    if (Array.isArray(e)) {
                        for (let r of e)
                ...
                RawProxy(e, t, r) {
                    if (!e || !t || !Reflect.has(e, t))
                        return;
                    let n = Reflect.get(e, t);
                    delete e[t];
                    let a = {};
                    r.construct && (a.construct = function(e, t, n) {
                        let i, a = !1, s = {
                            fn: e,
                            this: null,
                            args: t,
                            ...
                            ,
                            call: () => (a = !0,
                            i = Reflect.construct(s.fn, s.args, s.newTarget))
                        };
                        return (r.construct(s),
                        a) ? i : Reflect.construct(s.fn, s.args, s.newTarget)
                    }
                    ),
                    r.apply && (a.apply = (e, t, n) => {
                        let i, a = !1, s = {
                            fn: e,
                            this: t,
                            args: n,
                            ...
                            ,
                            call: () => (a = !0,
                            i = Reflect.apply(s.fn, s.this, s.args))
                        }, o = Error.prepareStackTrace;
                        Error.prepareStackTrace = function(e, t) {
                            if (t[0].getFileName() && !t[0].getFileName().startsWith(location.origin + c.$W.prefix))
                                return {
                                    stack: e.stack
                                }
                        }
                        ...
                        try {
                            ...
                            if (e instanceof Error)
                                if (e.stack instanceof Object) {
                                    ...
                                    !(0,
                                    c.U5)("allowFailedIntercepts", this.url))
                                        throw e
                                } else
                                    throw e;
                            else
                        ...
                        return (Error.prepareStackTrace = o,
                        a) ? i : Reflect.apply(s.fn, s.this, s.args)
                    }
                    ),
                    a.getOwnPropertyDescriptor = i.getOwnPropertyDescriptorHandler,
                    e[t] = new Proxy(n,a)
                }
                Trap(e, t) {
                    if (Array.isArray(e)) {
                    ...
                    if (!i)
                        return;
                    let a = this.natives.call("Object.getOwnPropertyDescriptor", null, i, n);
                    return this.descriptors.store[e] = a,
                    this.RawTrap(i, n, t)
                }
                RawTrap(e, t, r) {
                    if (!e || !t || !Reflect.has(e, t))
                        return;
                    let n = this.natives.call("Object.getOwnPropertyDescriptor", null, e, t)
                      , i = {
                        this: null,
                        get: function() {
                    ...
                    : n?.get && (a.get = n.get),
                    r.set ? a.set = function(e) {
                        i.this = this,
                        r.set(i, e)
                    }
                    : n?.set && (a.set = n.set),
                    r.enumerable ? a.enumerable = r.enumerable : n?.enumerable && (a.enumerable = n.enumerable),
                    r.configurable ? a.configurable = r.configurable : n?.configurable && (a.configurable = n.configurable),
                        ...
                        let t = e.get()
                          , r = new Proxy(t,{
                            get(e, n, i) {
                                ...
                                return "length" === n ? Object.keys(r).length : "getNamedItem" === n ? e => r[e] : "getNamedItemNS" === n ? (e, t) => r[`${e}:${t}`] : n in NamedNodeMap.prototype && "function" == typeof a ? new Proxy(a,{
                                    apply: (e, n, i) => n === r ? Reflect.apply(e, t, i) : Reflect.apply(e, n, i)
                                }) : "string" != typeof n && "number" != typeof n || isNaN(Number(n)) ? this.has(e, n) ? a : void 0 : t[Object.keys(r)[n]]
                            },
                            ownKeys(e) {
                    ...
                    get(t) {
                        ...
                        return new Proxy(r,{
                            get(e, t) {
                                ...
                                return "function" == typeof i ? new Proxy(i,{
                                    apply: (e, t, n) => Reflect.apply(e, r, n)
                                }) : t in CSSStyleDeclaration.prototype || !i ? i : (0,
                                n.f)(i)
                            },
                            set: (t, r, i) => "cssText" == r || "" == i || "string" != typeof i ? Reflect.set(t, r, i) : Reflect.set(t, r, (0,
                            n.s)(i, e.meta))
                        })
                    },
                    set(e, t) {
        ...
        5351: function(e, t, r) {
            ...
            function i(e, t) {
                ...
                e.Proxy(["Document.prototype.querySelector", "Document.prototype.querySelectorAll"], {
                    apply(e) {
                        e.args[0] = r(e.args[0]).replace(/((?:^|\s)\b\w+\[(?:src|href|data-href))[\^]?(=['"]?(?:https?[:])?\/\/)/, "$1*$2")
                    }
                }),
                e.Proxy("Document.prototype.write", {
                    apply(t) {
                        if (t.args[0])
                            try {
                                t.args[0] = (0,
                                n.Qs)(t.args[0], e.cookieStore, e.meta, !1)
                            } catch {}
                    }
                }),
                e.Trap("Document.prototype.referrer", {
                    get: () => e.url.toString()
                }),
        ...
        7828: function(e, t, r) {
            ...
            function h(e, t) {
                let r = {
                  ...
                  , p = [e.natives.call("Object.getOwnPropertyDescriptor", null, t.HTMLAnchorElement.prototype, "href"), e.natives.call("Object.getOwnPropertyDescriptor", null, t.HTMLAreaElement.prototype, "href")];
                for (let t of Object.keys(r))
                    for (let n of r[t]) {
                        let r = e.natives.call("Object.getOwnPropertyDescriptor", null, n.prototype, t);
                        Object.defineProperty(n.prototype, t, {
                            get() {
                                return ["src", "data", "href", "action", "formaction"].includes(t) ? (0,
                                o.v2)(r.get.call(this)) : r.get.call(this)
                            },
                            set(e) {
                ...
                e.Trap("Node.prototype.baseURI", {
                    get(t) {
                        ...
                        return (r instanceof Document && (n = r.querySelector("base")),
                        n) ? new URL(n.href,e.url.origin).href : e.url.origin
                    },
                    set: (e, t) => !1
                }),
                ...
                e.Proxy("Element.prototype.setAttribute", {
                    apply(t) {
                        ...
                        if (a) {
                            let n = a.fn(i, e.meta, e.cookieStore);
                            if (null == n) {
                                e.natives.call("Element.prototype.removeAttribute", t.this, r),
                                t.return(void 0);
                                return
                            }
                            t.args[1] = n,
                ...
                e.Proxy("Element.prototype.setAttributeNS", {
                    apply(t) {
                        ...
                        s && (t.args[2] = s.fn(a, e.meta, e.cookieStore),
                        e.natives.call("Element.prototype.setAttribute", t.this, `scramjet-attr-${t.args[1]}`, a))
                    }
                }),
                ...
                e.Trap("Element.prototype.innerHTML", {
                    set(r, n) {
                        ...
                        if (r.this instanceof t.HTMLScriptElement)
                            o = (0,
                            s.o)(n, "(anonymous script element)", e.meta),
                            e.natives.call("Element.prototype.setAttribute", r.this, "scramjet-attr-script-source-src", d(u.encode(o)));
                    ...
                    get(r) {
                        ...
                        return r.this instanceof t.HTMLStyleElement ? r.get() : (0,
                        a.nK)(r.get())
                    }
                }),
                e.Trap("Node.prototype.textContent", {
                    set(r, n) {
                        if (r.this instanceof t.HTMLScriptElement) {
                            let t = (0,
                            s.o)(n, "(anonymous script element)", e.meta);
                            return e.natives.call("Element.prototype.setAttribute", r.this, "scramjet-attr-script-source-src", d(u.encode(t))),
                            r.set(t)
                        }
                        return r.this instanceof t.HTMLStyleElement ? r.set((0,
                        i.s)(n, e.meta)) : r.set(n)
                    },
                    get(r) {
                        if (r.this instanceof t.HTMLScriptElement) {
                            let t = e.natives.call("Element.prototype.getAttribute", r.this, "scramjet-attr-script-source-src");
                        ...
                        return r.this instanceof t.HTMLStyleElement ? (0,
                        i.f)(r.get()) : r.get()
                    }
                }),
                ...
                e.Proxy("Element.prototype.setHTMLUnsafe", {
                    apply(t) {
                        try {
                            t.args[0] = (0,
                            a.Qs)(t.args[0], e.cookieStore, e.meta, !1)
                        } catch {}
                    }
                }),
                ...
                e.Proxy("Element.prototype.insertAdjacentHTML", {
                    apply(t) {
                        if (t.args[1])
                            try {
                                t.args[1] = (0,
                                a.Qs)(t.args[1], e.cookieStore, e.meta, !1)
                            } catch {}
                    }
                }),
                e.Proxy("Audio", {
                    construct(t) {
                        t.args[0] && (t.args[0] = (0,
                        o.Oy)(t.args[0], e.meta))
                    }
                }),
                e.Proxy("Text.prototype.appendData", {
                    apply(t) {
                        t.this.parentElement?.tagName === "STYLE" && (t.args[0] = (0,
                        i.s)(t.args[0], e.meta))
                    }
                }),
                e.Proxy("Text.prototype.insertData", {
                    apply(t) {
                        t.this.parentElement?.tagName === "STYLE" && (t.args[1] = (0,
                        i.s)(t.args[1], e.meta))
                    }
                }),
                e.Proxy("Text.prototype.replaceData", {
                    apply(t) {
                        t.this.parentElement?.tagName === "STYLE" && (t.args[2] = (0,
                        i.s)(t.args[2], e.meta))
                    }
                }),
                e.Trap("Text.prototype.wholeText", {
                    get: e => e.this.parentElement?.tagName === "STYLE" ? (0,
                    i.f)(e.get()) : e.get(),
                    set: (t, r) => t.this.parentElement?.tagName === "STYLE" ? t.set((0,
                    i.s)(r, e.meta)) : t.set(r)
                }),
                e.Trap(["HTMLIFrameElement.prototype.contentWindow", "HTMLFrameElement.prototype.contentWindow", "HTMLObjectElement.prototype.contentWindow", "HTMLEmbedElement.prototype.contentWindow"], {
                    get(e) {
                        let t = e.get();
                        return t && (l.pX in t || new c.ScramjetClient(t).hook()),
                        t
                    }
                }),
                e.Trap(["HTMLIFrameElement.prototype.contentDocument", "HTMLFrameElement.prototype.contentDocument", "HTMLObjectElement.prototype.contentDocument", "HTMLEmbedElement.prototype.contentDocument"], {
                    get(t) {
                        ...
                        return r ? (l.pX in r || new c.ScramjetClient(r).hook(),
                        r.document) : r
                    }
                }),
                e.Proxy(["HTMLIFrameElement.prototype.getSVGDocument", "HTMLObjectElement.prototype.getSVGDocument", "HTMLEmbedElement.prototype.getSVGDocument"], {
                    apply(e) {
                        if (e.call())
                            return e.return(e.this.contentDocument)
                    }
                }),
        ...
        5465: function(e, t, r) {
            ...
            function i(e, t) {
                e.Proxy("Range.prototype.createContextualFragment", {
                    apply(t) {
                        t.args[0] = (0,
                        n.Qs)(t.args[0], e.cookieStore, e.meta)
                    }
                })
            }
        },
        9804: function(e, t, r) {
            ...
            var n = r(1472)
              ...
              , a = r(2794);
            function s(e, t) {
                e.Proxy(["History.prototype.pushState", "History.prototype.replaceState"], {
                    apply(t) {
                        (t.args[2] || "" === t.args[2]) && (t.args[2] = (0,
                        n.Oy)(t.args[2], e.meta)),
                        t.call();
                        let {constructor: {constructor: r}} = t.this
                          , s = r("return globalThis")()
                          , o = s[a.pX];
                        if (s.name === e.meta.topFrameName) {
                            let t = new i.UrlChangeEvent(o.url.href);
        ...
        7758: function(e, t, r) {
            ...
            function s(e) {
                e.Proxy("window.open", {
                    apply(t) {
                        t.args[0] && (t.args[0] = (0,
                        a.Oy)(t.args[0], e.meta)),
                        ("_top" === t.args[1] || "_unfencedTop" === t.args[1]) && (t.args[1] = e.meta.topFrameName),
                        "_parent" === t.args[1] && (t.args[1] = e.meta.parentFrameName);
                        let r = t.call();
                        if (!r)
                            return t.return(r);
                        if (i.pX in r)
                            return t.return(r[i.pX].global);
                        {
        ...
        6286: function(e, t, r) {
            ...
            function a(e, t) {
                e.Trap("PerformanceEntry.prototype.name", {
                    get(e) {
                        let t = e.get();
                        return t && t.startsWith(location.origin + i.$W.prefix) ? (0,
                        n.v2)(t) : t
                    }
                }),
                e.Proxy(["Performance.prototype.getEntries", "Performance.prototype.getEntriesByType", "Performance.prototype.getEntriesByName", "PerformanceObserverEntryList.prototype.getEntries", "PerformanceObserverEntryList.prototype.getEntriesByType", "PerformanceObserverEntryList.prototype.getEntriesByName"], {
                    apply(e) {
                        let t = e.call();
                        return e.return(t.filter(e => {
                            for (let t of Object.values(i.$W.files))
                                if (e.name.startsWith(location.origin + t))
                                    return !1;
                            return !0
                        }
                        ))
            ...
            function l(e, t) {
                ...
                e.Proxy("ServiceWorkerContainer.prototype.register", {
                    apply(t) {
                        ...
                        Object.setPrototypeOf(n, self.ServiceWorkerRegistration.prototype),
                        n.constructor = t.fn;
                        let a = (0,
                        i.Oy)(t.args[0], e.meta) + "?dest=serviceworker";
                        t.args[1] && "module" === t.args[1].type && (a += "&type=module");
        ...
        5289: function(e, t, r) {
            function n(e, t) {
                let r = {
                    ...
                    set: (t, r, n) => (t.setItem(e.url.host + "@" + r, n),
                    !0),
                    ...
                    defineProperty: (t, r, n) => (t.setItem(e.url.host + "@" + r, n.value),
                    !0)
                };
                t.localStorage;
        ...
        1323: function(e, t, r) {
            ...
            let c = "window"in globalThis && window instanceof Window
              ...
              , f = "location"in globalThis && "serviceworker" === new URL(globalThis.location.href).searchParams.get("dest");
            function g(e) {
                if ((0,
                n.Nk)(e),
                l.log("loaded page"),
                !(i.pX in globalThis)) {
                    ...
                    t && !t.name && (t.name = `${Array(8).fill(0).map( () => Math.floor(36 * Math.random()).toString(36)).join("")}`),
        ...
        3255: function(e, t, r) {
            ...
            r.d(t, {
                ...
                getOwnPropertyDescriptorHandler: () => s.getOwnPropertyDescriptorHandler,
        ...
        3696: function(e, t, r) {
            ...
            function s(e, t) {
                ...
                s.constructor = r;
                let o = a.iswindow ? t.location : r.prototype;
                for (let r of ["protocol", "hash", "host", "hostname", "href", "origin", "pathname", "port", "search"]) {
                    let i = e.natives.call("Object.getOwnPropertyDescriptor", null, o, r);
                    if (!i)
                        continue;
                    let a = {
                        configurable: !1,
                ...
                return s.toString = new Proxy(t.location.toString,{
                    apply: () => e.url.href
                }),
                t.location.valueOf && (s.valueOf = new Proxy(t.location.valueOf,{
                    apply: () => e.url.href
                })),
                t.location.assign && (s.assign = new Proxy(t.location.assign,{
                    apply(r, a, s) {
                        s[0] = (0,
                        i.Oy)(s[0], e.meta),
                        Reflect.apply(r, t.location, s);
                        let o = new n.UrlChangeEvent(e.url.href);
                        e.isSubframe || e.frame?.dispatchEvent(o)
                    }
                })),
                t.location.reload && (s.reload = new Proxy(t.location.reload,{
                    apply(e, r, n) {
                        Reflect.apply(e, t.location, n)
                    }
                })),
                t.location.replace && (s.replace = new Proxy(t.location.replace,{
                    apply(r, a, s) {
                        s[0] = (0,
                        i.Oy)(s[0], e.meta),
                        Reflect.apply(r, t.location, s);
        ...
        4634: function(e, t, r) {
            ...
            function i(e) {
                e.Proxy("URL.createObjectURL", {
                    apply(t) {
                        let r = t.call();
                        r.startsWith("blob:") ? t.return((0,
                        n.IP)(r, e.meta)) : t.return(r)
                    }
                }),
        ...
        5026: function(e, t, r) {
            ...
            function i(e, t) {
                ...
                e.Proxy("CacheStorage.prototype.match", {
                    apply(t) {
                        ("string" == typeof t.args[0] || t.args[0]instanceof URL) && (t.args[0] = (0,
                        n.Oy)(t.args[0], e.meta))
                    }
                }),
                ...
                e.Proxy("Cache.prototype.addAll", {
                    apply(t) {
                        for (let r = 0; r < t.args[0].length; r++)
                            ("string" == typeof t.args[0][r] || t.args[0][r]instanceof URL) && (t.args[0][r] = (0,
                            n.Oy)(t.args[0][r], e.meta))
                    }
                }),
                ...
                e.Proxy("Cache.prototype.matchAll", {
                    apply(t) {
                        (t.args[0] && "string" == typeof t.args[0] || t.args[0] && t.args[0]instanceof URL) && (t.args[0] = (0,
                        n.Oy)(t.args[0], e.meta))
                    }
                }),
        ...
        6627: function(e, t, r) {
            ...
            function i(e, t) {
                ...
                n.iswindow && (r("MediaDevices.prototype.setCaptureHandleConfig"),
        ...
        582: function(e, t, r) {
            ...
            function s(e, t) {
                ...
                t.$scramdbg = function(e, t) {
                    return e && "object" == typeof e && e.length > 0 && a(e),
                    a(t),
                    t
                }
                ,
        ...
        6143: function(e, t, r) {
            ...
            var n = r(37)
              , i = r(1472);
            let a = e => (0,
            n.U5)("cleanErrors", e.url);
            function s(e, t) {
                let r = (e, t) => {
                    let r = e.stack;
                    for (let e = 0; e < t.length; e++) {
                        let a = t[e].getFileName();
                        try {
                            if (a.endsWith(n.$W.files.all)) {
                                let e = r.split("\n")
                                  , t = e.find(e => e.includes(a));
                                e.splice(t, 1),
                                r = e.join("\n");
                                continue
                            }
        ...
        591: function(e, t, r) {
            ...
            function a(e, t) {
                Object.defineProperty(t, n.$W.globals.rewritefn, {
                    value: function(t) {
                        ...
                        i.o)(t, "(direct eval proxy)", e.meta)
                    },
                    writable: !1,
                    configurable: !1
                })
            ...
            function s(e, t) {
                let r;
                return "string" != typeof t ? t : ("accounts.google.com" === this.url.hostname ? (console.log("USING STRICT EVAL - BOTGUARD"),
                r = Function(`
			"use strict";
			return eval;
		`)) : r = this.global.eval,
                r((0,
                i.o)(t, "(indirect eval proxy)", this.meta)))
            }
        },
        3481: function(e, t, r) {
            r.r(t),
                    ...
                    return new Proxy(e,{
                        apply(e, n, i) {
                            ...
                            if (s.isTrusted) {
                                ...
                                if (e in r) {
                                    let t = r[e];
                                    if (t._init && !1 === t._init.call(s))
                                        return;
                                    i[0] = new Proxy(s,{
                                        get(e, r, n) {
                                            let i = Reflect.get(e, r);
                                            return r in t ? t[r].call(e) : "function" == typeof i ? new Proxy(i,{
                                                apply: (e, t, r) => t === n ? Reflect.apply(e, s, r) : Reflect.apply(e, t, r)
                                            }) : i
                                        },
                ...
                l))
                    for (let t of Reflect.ownKeys(i))
                        if ("string" == typeof t && t.startsWith("on") && r[t.slice(2)]) {
                            let r = e.natives.call("Object.getOwnPropertyDescriptor", null, i, t);
                            if (!r.get || !r.set || !r.configurable)
                                continue;
                            e.RawTrap(i, t, {
                                get(e) {
                                    return this[s] ? this[s] : e.get()
                                },
                                set(e, t) {
                                    if (this[s] = t,
                                    "function" != typeof t)
        ...
        249: function(e, t, r) {
            ...
            function i(e, t) {
                let r = e.call().toString()
                  , i = (0,
                n.o)(`return ${r}`, "(function proxy)", t.meta);
                e.return(e.fn(i)())
            }
            function a(e, t) {
                let r = {
                ...
                let n = e.natives.call("eval", null, "(function () {})").constructor
                  , a = e.natives.call("eval", null, "(async function () {})").constructor
                  , s = e.natives.call("eval", null, "(function* () {})").constructor
                  , o = e.natives.call("eval", null, "(async function* () {})").constructor;
        ...
        2468: function(e, t, r) {
            ...
            function a(e, t) {
                ...
                Object.defineProperty(t, n.$W.globals.importfn, {
                    value: function(t, n) {
                        let a = new URL(n,t).href;
                        return n.includes(":") || n.startsWith("/") || n.startsWith(".") || n.startsWith("..") ? r(`${(0,
                        i.Oy)(a, e.meta)}?type=module`) : r(n)
                    },
                    writable: !1,
                    configurable: !1,
                    enumerable: !1
        ...
        1320: function(e, t, r) {
            ...
            function s(e) {
                n.iswindow && e.Proxy("window.postMessage", {
                    apply(e) {
                        let {constructor: {constructor: t}} = "object" == typeof e.args[0] && null !== e.args[0] ? e.args[0] : "object" == typeof e.args[2] && null !== e.args[2] ? e.args[2] : e.this && a.POLLUTANT in e.this && "object" == typeof e.this[a.POLLUTANT] && null !== e.this[a.POLLUTANT] ? e.this[a.POLLUTANT] : {}
                        ...
                        "object" == typeof e.args[1] && (e.args[1].targetOrigin = "*"),
            ...
            function n(e, t) {
                ...
                e.Proxy("WebSocket", {
                    construct(n) {
                        ...
                        Object.setPrototypeOf(i, n.fn.prototype),
                        i.constructor = n.fn;
                        let a = e.bare.createWebSocket(n.args[0], n.args[1], null, {
                        ...
                        a.addEventListener("message", async e => {
                            let t = e.data;
                            "string" == typeof t || ("byteLength"in t ? "blob" === s.binaryType ? t = new Blob([t]) : Object.setPrototypeOf(t, ArrayBuffer.prototype) : "arrayBuffer"in t && "arraybuffer" === s.binaryType && Object.setPrototypeOf(t = await t.arrayBuffer(), ArrayBuffer.prototype)),
                ...
                e.Proxy("WebSocketStream", {
                    construct(r) {
                        let i, a, s, o = {};
                        Object.setPrototypeOf(o, r.fn.prototype),
                        o.constructor = r.fn;
                            ...
                            readable: new ReadableStream({
                                start(e) {
                                    l.addEventListener("message", async t => {
                                        let r = t.data;
                                        "string" == typeof r || ("byteLength"in r ? Object.setPrototypeOf(r, ArrayBuffer.prototype) : "arrayBuffer"in r && Object.setPrototypeOf(r = await r.arrayBuffer(), ArrayBuffer.prototype)),
                                        e.enqueue(r)
                                    }
                                    )
                                }
                ...
                e.Proxy("WebSocketStream.prototype.close", {
                    apply(e) {
                        let t = n.get(e.this);
                        return e.args[0] ? (void 0 === e.args[0].closeCode && (e.args[0].closeCode = 1e3),
                        void 0 === e.args[0].reason && (e.args[0].reason = ""),
                        e.return(t.barews.close(e.args[0].closeCode, e.args[0].reason))) : e.return(t.barews.close(1e3, ""))
                    }
                })
            }
            r.r(t),
            ...
            function a(e, t) {
                ...
                e.Proxy("XMLHttpRequest.prototype.send", {
                    apply(t) {
                        ...
                        if (!(0,
                        n.U5)("syncxhr", e.url))
                            return console.warn("ignoring request - sync xhr disabled in flags"),
                            t.return(void 0);
                        ...
                        for (; 0 === l.getUint8(0); )
                            if (performance.now() - c > 1e3)
                                throw Error("xhr timeout");
                        let u = l.getUint16(1)
                          , d = l.getUint32(3)
                          , h = new Uint8Array(d);
        ...
        7418: function(e, t, r) {
            ...
            function i(e, t) {
                e.Proxy(["setTimeout", "setInterval"], {
                    apply(t) {
                        t.args.length > 0 && "string" == typeof t.args[0] && (t.args[0] = (0,
                        n.o)(t.args[0], "(setTimeout string eval)", e.meta))
                    }
                })
            }
        },
                            ...
                            for (let e = 0; e < o; e++) {
                                ...
                                0 == r)
                                    ...
                                    let o = e + t
                                      , c = i.getUint32(l, !0);
                                    l += 4;
                                    let u = a.decode(n.subarray(l, l + c));
                                    s.push({
                                        type: r,
                                        start: e,
                                        end: o,
                        ...
                        function(e, t) {
                            let r = t.fn.call(t.this)
                              , n = function(e) {
                                ...
                                let r = e.indexOf("*/", t);
                                if (-1 === r)
                                    throw console.log(e, t, r),
                                    Error("unreachable");
                                let n = e.substring(t + 2, r).split(" ");
                                if (3 !== n.length || "scramtag" !== n[0] || !Number.isSafeInteger(+n[1]))
                                    throw console.log(e, t, r, n),
                                    Error("invalid tag");
                                return [n[2], t, +n[1]]
                            }(r);
                            if (!n)
                            ...
                            let[i,s,o] = n
                              , l = o - s
                              , c = l + r.length
                              , u = e.box.sourcemaps[i];
                            if (!u)
                                return console.warn("failed to get rewrites for tag", i),
                                t.return(r);
                            let d = 0;
                            for (; d < u.length; )
                                if (u[d].start < l)
        ...
        9399: function(e, t, r) {
            ...
            function a(e, t) {
                e.Proxy("Worker", {
                    construct(t) {
                        t.args[0] = (0,
                        i.Oy)(t.args[0], e.meta) + "?dest=worker",
                        t.args[1] && "module" === t.args[1].type && (t.args[0] += "&type=module");
                        let r = t.call()
                          , a = new n.DD;
                        (async () => {
                ...
                e.Proxy("SharedWorker", {
                    construct(t) {
                        t.args[0] = (0,
                        i.Oy)(t.args[0], e.meta) + "?dest=sharedworker",
                        t.args[1] && "string" == typeof t.args[1] && (t.args[1] = `${e.url.origin}@${t.args[1]}`),
                        t.args[1] && "object" == typeof t.args[1] && ("module" === t.args[1].type && (t.args[0] += "&type=module"),
                        t.args[1].name && (t.args[1].name = `${e.url.origin}@${t.args[1].name}`));
                        let r = t.call()
                          , a = new n.DD;
                        (async () => {
                            let t = await a.getInnerPort();
                ...
                e.Proxy("Worklet.prototype.addModule", {
                    apply(t) {
                        t.args[0] && (t.args[0] = (0,
                        i.Oy)(t.args[0], e.meta) + "?dest=worklet")
                    }
                })
            }
        },
        581: function(e, t, r) {
            ...
            function o(e, t) {
                return function(r, a) {
                    if (r === t.location)
                        return e.locationProxy;
                    if (r === t.eval)
                        return s.indirectEval.bind(e, a);
                    if (n.iswindow) {
                        if (r === t.parent)
                            if (i.pX in t.parent)
                                return t.parent;
            ...
            let l = 4;
            function c(e, t) {
                Object.defineProperty(t, a.$W.globals.wrapfn, {
                    value: e.wrapfn,
                    writable: !1,
                    configurable: !1,
                    enumerable: !1
                }),
                Object.defineProperty(t, a.$W.globals.wrappropertyfn, {
                    value: function(e) {
                        return "location" === e || "parent" === e || "top" === e || "eval" === e ? a.$W.globals.wrappropertybase + e : e
                    },
                    writable: !1,
                    configurable: !1,
                    enumerable: !1
                }),
                Object.defineProperty(t, a.$W.globals.cleanrestfn, {
                    value: function(e) {},
                    writable: !1,
                    configurable: !1,
                    enumerable: !1
                }),
                Object.defineProperty(t.Object.prototype, a.$W.globals.wrappropertybase + "location", {
                    get: function() {
                ...
                Object.defineProperty(t.Object.prototype, a.$W.globals.wrappropertybase + "parent", {
                    get: function() {
                ...
                Object.defineProperty(t.Object.prototype, a.$W.globals.wrappropertybase + "top", {
                    get: function() {
                ...
                Object.defineProperty(t.Object.prototype, a.$W.globals.wrappropertybase + "eval", {
                    get: function() {
                ...
                ,
                Object.defineProperty(t, a.$W.globals.trysetfn, {
                    value: function(r, n, i) {
                        return r instanceof t.Location && (e.locationProxy.href = i,
                        !0)
                    },
                    writable: !1,
                    configurable: !1
        ...
        8409: function(e, t, r) {
            r.r(t),
            r.d(t, {
                ScramjetServiceWorkerRuntime: () => a
            });
            var n = r(1472)
              , i = r(8665).A;
            class a {
                ...
                constructor(e) {
                    ...
                    self.onconnect = t => {
                        ...
                        r.addEventListener("message", t => {
                            ...
                            "scramjet$type"in t.data && ("init" === t.data.scramjet$type ? (this.recvport = t.data.scramjet$port,
                    ...
                    for (let o of a) {
                        ...
                        c.respondWith = e => {
                            ...
                            (async () => {
                                ...
                                i.log("sw", "responding", t),
                                r.postMessage(t, [e.body])
                            }
                            )()
                        }
                        ,
                        i.log("to fn", c),
                        o.proxiedCallback(new Proxy(c,{
                            get: (e, t, r) => "isTrusted" === t || Reflect.get(e, t)
                        })),
                        u || (console.log("sw", "no response"),
                        r.postMessage({
                            scramjet$type: "fetch",
                            scramjet$token: s,
                            scramjet$response: !1
        ...
        3402: function(e, t, r) {
            ...
            class l extends EventTarget {
                ...
                constructor(e) {
                    ...
                    const t = (e, r) => {
                        for (let n in r)
                            r[n]instanceof Object && n in e && Object.assign(r[n], t(e[n], r[n]));
                ...
                async init() {
                    ...
                    navigator.serviceWorker.addEventListener("message", e => {
                        if (!("scramjet$type"in e.data))
                            return;
                        let t = e.data;
                        "download" === t.scramjet$type && this.dispatchEvent(new s.ScramjetGlobalDownloadEvent(t.download))
                    }
                    )
                }
                createFrame(e) {
                    return e || (e = document.createElement("iframe")),
                    new i.X(this,e)
                }
                encodeUrl(e) {
                ...
                async openIDB() {
                    ...
                    a.P2)("$scramjet", 1, {
                        upgrade(e) {
                            ...
                            e.objectStoreNames.contains("cookies") || e.createObjectStore("cookies"),
                            e.objectStoreNames.contains("redirectTrackers") || e.createObjectStore("redirectTrackers"),
                            e.objectStoreNames.contains("referrerPolicies") || e.createObjectStore("referrerPolicies"),
                            e.objectStoreNames.contains("publicSuffixList") || e.createObjectStore("publicSuffixList")
                        }
                    });
                    return this.db = e,
                    await this.#e(),
                ...
                async #e() {
                    this.db ? await this.db.put("config", n.$W, "config") : console.error("Store not ready!")
                }
                async modifyConfig(e) {
                    (0,
                    n.Nk)(Object.assign({}, n.$W, e)),
                    (0,
                    n.Ec)(),
                    await this.#e(),
                    navigator.serviceWorker.controller?.postMessage({
        ...
        4869: function(e, t, r) {
            ...
            class a extends EventTarget {
                ...
                constructor(e, t) {
                    ...
                    this.controller = e,
                    this.frame = t,
                    t.name = `${Array(8).fill(0).map( () => Math.floor(36 * Math.random()).toString(36)).join("")}`,
                    t[n.zr] = this
                }
                get client() {
                ...
                fmt: function(e, t, ...r) {
                    ...
                    Error.prepareStackTrace = (e, t) => {
                        ...
                        for (let e = 1; e < Math.min(2, t.length); e++)
                            t[e].getFunctionName() && (r += `${t[e].getFunctionName()} -> ` + r);
  ...
  `, `color: inherit;`, ...i)
            ...
            class a {
                ...
                getCookies(e, t) {
                    let r = new Date
                      ...
                      , i = [];
                    for (let a of n) {
                        if (a.expires && new Date(a.expires) < r) {
                            delete this.cookies[`${a.domain}@${a.path}@${a.name}`];
                            continue
                        }
                        (!a.secure || "https:" === e.protocol) && (!a.httpOnly || !t) && e.pathname.startsWith(a.path) && (!a.domain.startsWith(".") || e.hostname.endsWith(a.domain.slice(1))) && i.push(a)
                    }
        ...
        37: function(e, t, r) {
            ...
            let s = Function;
            function o() {
                n = s(`return ${a.codec.encode}`)(),
                i = s(`return ${a.codec.decode}`)()
            }
            function l(e, t) {
                let r = a.flags[e];
                for (let r in a.siteFlags) {
                    let n = a.siteFlags[r];
                    if (new RegExp(r).test(t.href) && e in n)
                        return n[e]
                }
                return r
            }
        ...
        2614: function(e, t, r) {
            ...
            function s(e, t, r) {
                ...
                )).replace(/@import\s+(url\s*?\(.{0,9999}?\)|['"].{0,9999}?['"]|.{0,9999}?)($|\s|;)/gm, (t, i) => t.replace(i, i.replace(/^(url\(['"]?|['"]|)(.+?)(['"]|['"]?\)|)$/gm, (t, i, a, s) => {
                    if (i.startsWith("url"))
                        return t;
                    let o = "rewrite" === e ? (0,
                    n.Oy)(a.trim(), r) : (0,
        ...
        4435: function(e, t, r) {
            ...
            var n = r(1472)
              , i = r(8228);
            let a = new Set(["cross-origin-embedder-policy", "cross-origin-opener-policy", "cross-origin-resource-policy", "content-security-policy", "content-security-policy-report-only", "expect-ct", "feature-policy", "origin-isolation", "strict-transport-security", "upgrade-insecure-requests", "x-content-type-options", "x-download-options", "x-frame-options", "x-permitted-cross-domain-policies", "x-powered-by", "x-xss-protection", "clear-site-data"])
              , s = new Set(["location", "content-location", "referer"]);
            function o(e, t) {
                return e.replace(/<(.*)>/gi, e => (0,
                n.Oy)(e, t))
            }
            async function l(e, t, r, l) {
                ...
                for (let e of s)
                    c[e] && (c[e] = (0,
                    n.Oy)(c[e]?.toString(), t));
                if ("string" == typeof c.link ? c.link = o(c.link, t) : Array.isArray(c.link) && (c.link = c.link.map(e => o(e, t))),
                ...
                return "string" == typeof c["sec-fetch-dest"] && "" === c["sec-fetch-dest"] && (c["sec-fetch-dest"] = "empty"),
                "string" == typeof c["sec-fetch-site"] && "none" !== c["sec-fetch-site"] && ("string" == typeof c.referer ? c["sec-fetch-site"] = await (0,
                i.ps)(t, new URL(c.referer), r) : (console.warn("Missing referrer header; can't rewrite sec-fetch-site properly. Falling back to unsafe deletion."),
	...
	`
                  , i = y(p.encode(n));
                return [t(c.$W.files.wasm), t(c.$W.files.all), t("data:application/javascript;base64," + i)]
            }
            ...
            function f(e, t, r, c=!1) {
                let g = performance.now()
                  , m = function(e, t, r, c=!1) {
                    ...
                    f.end(),
                    function e(t, r, n) {
                        if ("base" === t.name && void 0 !== t.attribs.href && (n.base = new URL(t.attribs.href,n.origin)),
                        t.attribs) {
                            for (let e of u.V)
                                for (let i in e) {
                                    let a = e[i.toLowerCase()];
                                    if ("function" != typeof a && ("*" === a || a.includes(t.name)) && void 0 !== t.attribs[i]) {
                                        let a = t.attribs[i]
                                          , s = e.fn(a, n, r);
                                        null === s ? delete t.attribs[i] : t.attribs[i] = s,
                                        t.attribs[`scramjet-attr-${i}`] = a
                                    }
                                }
                            for (let[e,r] of Object.entries(t.attribs))
                                b.includes(e) && (t.attribs[`scramjet-attr-${e}`] = r,
                                t.attribs[e] = (0,
                                l.o)(r, `(inline ${e} on element)`, n))
                        }
                        if ("style" === t.name && void 0 !== t.children[0] && (t.children[0].data = (0,
                        o.s)(t.children[0].data, n)),
                        "script" === t.name && "module" === t.attribs.type && t.attribs.src && (t.attribs.src = t.attribs.src + "?type=module"),
                        "script" === t.name && "importmap" === t.attribs.type && void 0 !== t.children[0]) {
                        ...
                        if ("script" === t.name && /(application|text)\/javascript|module|undefined/.test(t.attribs.type) && void 0 !== t.children[0]) {
                            ...
                            t.attribs["scramjet-attr-script-source-src"] = y(p.encode(e)),
                            e = e.replace(/<!--[\s\S]*?-->/g, ""),
                            t.children[0].data = (0,
                            l.o)(e, "(inline script element)", n, r)
                        }
                        if ("meta" === t.name && void 0 !== t.attribs["http-equiv"]) {
                            if ("content-security-policy" === t.attribs["http-equiv"].toLowerCase())
                    ...
                    c) {
                        ...
                        e || (e = new i.Hg("head",{},[]),
                        d.root.children.unshift(e)),
                        e.children.unshift(...h(t, e => new i.Hg("script",{
                            src: e
                        })))
                    }
                    return (0,
                ...
                return d.time(r, g, "html rewrite"),
                m
            }
            function g(e) {
                ...
                !function e(t) {
                    if ("attribs"in t)
                        for (let e in t.attribs) {
                            ...
                            e.startsWith("scramjet-attr-") && (t.attribs[e.slice(14)] = t.attribs[e],
                            delete t.attribs[e])
                        }
                    if ("childNodes"in t)
                        for (let r of t.childNodes)
                    ...
                    let s = function(e, t, r, n=!1) {
                        return function(e, t, r, n) {
                            ...
                            try {
                                ...
                                o = "string" == typeof e ? s.rewrite_js(e, r.base.href, t || "(unknown)", n) : s.rewrite_js_bytes(e, r.base.href, t || "(unknown)", n),
                      ...
                      , l = s.js;
                    if ((0,
                    n.U5)("sourcemaps", r.base)) {
                        let e = globalThis[n.$W.globals.pushsourcemapfn];
                        if (e)
                            e(Array.from(s.map), s.tag);
                        else {
                            l instanceof Uint8Array && (l = new TextDecoder().decode(l));
                            let e = `${n.$W.globals.pushsourcemapfn}([${s.map.join(",")}], "${s.tag}");`
                              , t = /^\s*(['"])use strict\1;?/;
                            l = t.test(l) ? l.replace(t, `$&
${e}`) : `${e}
${l}`
                        }
                    }
                    if ((0,
                    n.U5)("rewriterLogs", r.base))
                        for (let e of s.errors)
                            console.error("oxc parse error", e);
                    return l
                } catch (a) {
                    if (console.warn("failed rewriting js for", t || "(unknown)", a.message, e instanceof Uint8Array ? i.su.decode(e) : e),
                    (0,
                    n.U5)("allowInvalidJs", r.base))
                        return e;
                    throw a
                }
            }
        ...
        1472: function(e, t, r) {
            ...
            function l(e, t) {
                if (e instanceof URL && (e = e.toString()),
                e.startsWith("javascript:"))
                    return "javascript:" + (0,
                    i.o)(e.slice(11), "(javascript: url)", t);
                {
            ...
            function c(e) {
                    ...
                    return e;
                {
                    ...
                    return r.hash = "",
                    (0,
                    n.P_)(r.href.slice(t.length) + (i ? "#" + i : ""))
                }
            }
        },
        1561: function(e, t, r) {
            ...
            var i = r(3907)
              ...
              , u = r(884);
            async function d() {
                n = new Uint8Array(await fetch(a.$W.files.wasm).then(e => e.arrayBuffer()))
            }
            ...
            function g(e) {
                ...
                if (![...n.slice(0, 4)].every( (e, t) => e === p[t]))
                    throw Error("rewriter wasm does not have wasm magic (was it fetched correctly?)\nrewriter wasm contents: " + h.decode(n));
                (0,
                i.QR)({
                ...
                let r = f.findIndex(e => !e.inUse)
                  , d = f.length;
                return -1 === r ? ((0,
                a.U5)("rewriterLogs", e.base) && console.log(`creating new rewriter, ${d} rewriters made already`),
                t = {
                    rewriter: new i.LW({
                        config: a.$W,
                        shared: {
                            rewrite: {
                                ...
                                getHtmlInjectCode(e, t) {
                                    let r = (0,
                                    u.Uk)(e, e => `<script src="${e}"></script>`).join("");
                ...
                f.push(t)) : ((0,
                a.U5)("rewriterLogs", e.base) && console.log(`using cached rewriter ${r} from list of ${d} rewriters`),
                t = f[r]),
                t.inUse = !0,
...
`
                ...
                let c = (0,
                i.o)(e, r, a, o);
                return c instanceof Uint8Array && (c = new TextDecoder().decode(c)),
                s += c
            }
        },
        6684: function(e, t, r) {
            ...
            async function s(e) {
                let t = await a();
                return await t.get("redirectTrackers", e) || null
            }
            async function o(e, t) {
                let r = await a();
                await r.put("redirectTrackers", t, e)
            }
            async function l(e) {
                let t = await a();
                await t.delete("redirectTrackers", e)
            }
            ...
            async function d(e, t) {
                ...
                if (!r)
                    return t;
                let n = i[r.mostRestrictiveSite];
                return (i[t] ?? 0) > n ? (r.mostRestrictiveSite = t,
                await o(e, r),
                t) : r.mostRestrictiveSite
            }
            async function h(e) {
                await l(e)
            }
            ...
            async function f(e) {
                let t = await a();
                return await t.get("referrerPolicies", e) || null
            }
        },
        2416: function(e, t, r) {
            r(6684),
        ...
        8228: function(e, t, r) {
            ...
            async function s() {
                let e = await a();
                return await e.get("publicSuffixList", i) || null
            }
            async function o(e) {
                let t = await a();
                await t.put("publicSuffixList", {
                    data: e,
                    expiry: Date.now() + 36e5
                }, i)
            }
            async function l(e, t, r) {
                return t ? e.origin.origin === t.origin ? "same-origin" : await c(e.origin, t, r) ? "same-site" : "cross-site" : "none"
            }
            async function c(e, t, r) {
                return await u(e, r) === await u(t, r)
            }
...
.bg {
    ...
    inset: 0;
    background:
        radial-gradient(circle at 20% 30%, rgba(122,162,255,0.2), transparent 40%),
        radial-gradient(circle at 80% 70%, rgba(122,162,255,0.15), transparent 40%);
...
<div class="container">
    ...
    <img src="https://raw.githubusercontent.com/mrdavidzs/assets/refs/heads/main/icons/frosted.png" class="logo">

    <div class="brand">FROSTED</div>
    <div class="subtitle">We couldn't load <span id="fetchedURL">.</span></div>
    ...
    <div class="actions">
        <button id="reload"><i class="fas fa-redo"></i> Refresh</button>
    </div>
...
<script src="${"data:application/javascript," + encodeURIComponent(r)}"></script>
        ...
        `
            ...
            function i(e, t) {
                ...
                return crossOriginIsolated && (r["Cross-Origin-Embedder-Policy"] = "require-corp"),
                new Response(n(String(e), t),{
                    status: 500,
                    headers: r
                })
            }
        ...
        1403: function(e, t, r) {
            ...
            class n {
                ...
                handleMessage(e) {
                    ...
                    t && (t(e),
                    delete this.promises[e.scramjet$token])
                }
                async fetch(e) {
        ...
        5790: function(e, t, r) {
            ...
            async function m(e, t) {
                try {
                    ...
                    if (o.pathname === this.config.files.wasm)
                        return fetch(this.config.files.wasm).then(async e => {
                            let t = await e.arrayBuffer()
                              , r = btoa(new Uint8Array(t).reduce( (e, t) => (e.push(String.fromCharCode(t)),
                            e), []).join(""))
                              , n = "";
...
self.WASM = '${r}';`,
                    ...
                    for (let[e,t] of [...o.searchParams.entries()]) {
                        ...
                        case "parentFrame":
                            ...
                            break;
                        default:
                            f.warn(`${o.href} extraneous query parameter ${e}. Assuming <form> element`),
                            d[e] = t
                        }
                    ...
                    if (o.pathname.startsWith(`${this.config.prefix}blob:`) || o.pathname.startsWith(`${this.config.prefix}data:`)) {
                        ...
                        r.startsWith("blob:") && (r = (0,
                        s.$n)(r));
                        let n = await fetch(r, {});
                        n.finalURL = r.startsWith("blob:") ? r : "(data url)",
                        n.body && (t = await b(n, p, e.destination, u, this.cookieStore));
                        let i = Object.fromEntries(n.headers.entries());
                        return crossOriginIsolated && (i["Cross-Origin-Opener-Policy"] = "same-origin",
                    ...
                    let __requestedOrigin = new URL(e.url).origin;
                    let __allowSameOriginProxy = false;
                    try {
                        const __enc = encodeURIComponent(h.toString());
                        if (e.url.includes(this.config.prefix) && e.url.includes(__enc))
                            __allowSameOriginProxy = true;
                    } catch (__) {}
                    if (h.origin === __requestedOrigin && !__allowSameOriginProxy)
                        throw Error("attempted to fetch from same origin - this means the site has obtained a reference to the real origin, aborting");
                    let m = new l.u;
                    for (let[t,r] of e.headers.entries())
                        m.set(t, r);
                    if (t && new URL(t.url).pathname.startsWith(c.$W.prefix)) {
                        let e = new URL((0,
                        s.v2)(t.url));
                        e.toString().includes("youtube.com") || (m.set("Referer", e.href),
                        m.set("Origin", e.origin))
                    }
                    let w = this.cookieStore.getCookies(h, !1);
                    w.length && m.set("Cookie", w);
                    let v = !1;
                    if ("iframe" === e.destination && "navigate" === e.mode && e.referrer && "no-referrer" !== e.referrer && e.referrer !== location.origin + c.$W.prefix + "no-referrer") {
                        let t = e.referrer
                        ...
                        for (; t; ) {
                            ...
                            if (e && "nested" === e.frameType)
                                t = n.referrer;
                            else
                                break
                        }
                    }
                    v ? (m.set("Sec-Fetch-Dest", "document"),
                    m.set("Sec-Fetch-Mode", "navigate")) : (m.set("Sec-Fetch-Dest", e.destination || "empty"),
                    m.set("Sec-Fetch-Mode", e.mode));
                    let x = "none";
                    if (e.referrer && "" !== e.referrer && "no-referrer" !== e.referrer && e.referrer !== location.origin + c.$W.prefix + "no-referrer" && e.referrer.includes(c.$W.prefix)) {
                        let t = (0,
                        s.v2)(e.referrer);
                        if (t) {
                            let e = new URL(t);
                            x = await (0,
                            i.ps)(p, e, this.client)
                        }
                    }
                    await (0,
                    a.rj)(h.toString(), e.referrer ? (0,
                    s.v2)(e.referrer) : null, x),
                    m.set("Sec-Fetch-Site", await (0,
                    a.hU)(h.toString(), x));
                    ...
                    return T.finalURL = E.url.href,
                    await y(h, p, u, e.destination, e.mode, T, this.cookieStore, t, this.client, this, e.referrer)
                } catch (i) {
                    let t = {
                        message: i.message,
                        url: e.url,
            ...
            async function y(e, t, r, n, o, l, d, h, p, f, m) {
                let y, S = "navigate" === o && ["document", "iframe"].includes(n), v = await (0,
                u.l)(l.rawHeaders, t, p, {
                    get: a.Yq,
                    set: a.pL
                });
                if (S && v["referrer-policy"] && m && await (0,
                a.pL)(e.href, v["referrer-policy"], m),
                g(l)) {
                    let t = new URL((0,
                    s.v2)(v.location));
                    await (0,
                    a.YH)(e.toString(), t.toString(), v["referrer-policy"]);
                    let n = await (0,
                    i.ps)({
                        origin: t,
                        base: t
                    ...
                    a.hU)(t.toString(), n),
                    r) {
                        let e = new URL(v.location);
                        e.searchParams.set("type", r),
                        v.location = e.href
                    }
                }
                let x = v["set-cookie"] || [];
                ...
                for (let t in await d.setCookies(x instanceof Array ? x : [x], e),
                v)
                    Array.isArray(v[t]) && (v[t] = v[t][0]);
                if (function(e, t) {
                    if (["document", "iframe"].includes(t)) {
                        ...
                        if (t) {
                            ...
                            if (t && !["text/html", "text/plain", "text/css", "text/javascript", "text/xml", "application/javascript", "application/json", "application/xml", "application/pdf"].includes(t) && !t.startsWith("text") && !t.startsWith("image") && !t.startsWith("font") && !t.startsWith("video"))
                                return !0
                        }
                    }
                    return !1
                    ...
                    if ((0,
                    c.U5)("interceptDownloads", e)) {
                        if (!h)
                            throw Error("cant find client");
                        let t = null
                          , r = v["content-disposition"];
                        if ("string" == typeof r) {
                            let e = r.match(/filename=["']?([^"';\n]*)["']?/i);
                            e && e[1] && (t = e[1])
                        }
                        let n = v["content-length"]
                          , i = await clients.matchAll({});
                        if ((i = i.filter(e => !e.url.includes(c.$W.prefix))).length < 1)
                        ...
                        if (!/\s*?((inline|attachment);\s*?)filename=/i.test(e)) {
                            ...
                            v["content-disposition"] = `${t}; filename=${JSON.stringify(r)}`
                        }
                    }
                l.body && !g(l) && (y = await b(l, t, n, r, d)),
                "text/event-stream" === v.accept && (v["content-type"] = "text/event-stream"),
                delete v["permissions-policy"],
                crossOriginIsolated && ["document", "iframe", "worker", "sharedworker", "style", "script"].includes(n) && (v["Cross-Origin-Embedder-Policy"] = "require-corp",
                v["Cross-Origin-Opener-Policy"] = "same-origin");
                let E = new w(y,v,l.status,l.statusText,n,e,l,h);
                return f.dispatchEvent(E),
                g(l) || await (0,
                a.Sn)(e.toString()),
            ...
            async function b(e, t, r, n, i) {
                ...
                case "document":
                    if (e.headers.get("content-type")?.startsWith("text/html"))
                        return (0,
                        d.Qs)(await e.text(), i, t, !0);
                    return e.body;
                case "script":
                    return (0,
                    o.o)(new Uint8Array(await e.arrayBuffer()), e.finalURL, t, "module" === n);
                case "style":
                    return (0,
                    h.s)(await e.text(), t);
                case "sharedworker":
                case "worker":
                    return (0,
                    p.i)(new Uint8Array(await e.arrayBuffer()), n, e.finalURL, t);
                default:
                    return e.body
                }
            }
        ...
        7510: function(e, t, r) {
            ...
            class d extends EventTarget {
                    ...
                    addEventListener("message", async ({data: e}) => {
                        if ("scramjet$type"in e) {
                            if ("scramjet$token"in e) {
                                ...
                                delete this.syncPool[e.scramjet$token],
                                t(e);
                                return
                            }
                            if ("registerServiceWorker" === e.scramjet$type)
                                return void this.serviceWorkers.push(new n.H(e.port,e.origin));
                ...
                async dispatch(e, t) {
                    let r, n = this.synctoken++, i = new Promise(e => r = e);
                    return this.syncPool[n] = r,
                    t.scramjet$token = n,
                    e.postMessage(t),
                    await i
                }
        ...
        236: function(e, t, r) {
            ...
            async function c() {
                let e = Promise.race([Promise.any((await self.clients.matchAll({
                    ...
                    let t, r = await (t = new MessageChannel,
                    new Promise(r => {
                        e.postMessage({
                            type: "getPort",
                            port: t.port2
            ...
            class f extends EventTarget {
                constructor(e, t=[], r, n) {
                    ...
                    this.channel.port1.onmessage = e => {
                        "open" === e.data.type ? i(e.data.args[0]) : "message" === e.data.type ? a(e.data.args[0]) : "close" === e.data.type ? s(e.data.args[0], e.data.args[1]) : "error" === e.data.type && o()
                    }
                    ,
                    r.sendMessage({
                        type: "websocket",
		...
		`, t, r)
                        ...
                        if ("fetch" === n.type)
                            try {
                                ...
                                await async function(e, t, r) {
                                    ...
                                    if (!function() {
                                        if (null === h) {
                                            let e, t = new MessageChannel, r = new ReadableStream;
                                            try {
                                                o.call(t.port1, r, [r]),
                                                e = !0
                                            } catch (t) {
                            ...
                            try {
                                e.ready || await e.init(),
                                await async function(e, t, r) {
                                    let[n,i] = r.connect(new URL(e.websocket.url), e.websocket.protocols, e.websocket.requestHeaders, t => {
                                    ...
                                    e.websocket.channel.onmessage = e => {
                                        "data" === e.data.type ? n(e.data.data) : "close" === e.data.type && i(e.data.closeCode, e.data.closeReason)
                                    }
                                    ,
                                    o.call(t, {
                                        type: "websocket"
            ...
            class S {
                ...
                createWebSocket(e, t=[], r, n) {
                    ...
                    return n = n || {},
                    new f(e,t,this.worker,n)
                }
                async fetch(e, t) {
                    let r = new Request(e,t)
                      , i = t?.headers || r.headers
                      , a = i instanceof Headers ? Object.fromEntries(i) : i
                      , s = r.body
                      , o = new URL(r.url);
                    ...
                    for (let e = 0; ; e++) {
                        ...
                        i.rawResponse = n,
                        i.finalURL = o.toString();
                        let l = t?.redirect || r.redirect;
                        if (!b.includes(i.status))
                            return i;
                        switch (l) {
                        case "follow":
                            {
        ...
        8832: function(e, t, r) {
            ...
            let n = new Map(["altGlyph", "altGlyphDef", "altGlyphItem", "animateColor", "animateMotion", "animateTransform", "clipPath", "feBlend", "feColorMatrix", "feComponentTransfer", "feComposite", "feConvolveMatrix", "feDiffuseLighting", "feDisplacementMap", "feDistantLight", "feDropShadow", "feFlood", "feFuncA", "feFuncB", "feFuncG", "feFuncR", "feGaussianBlur", "feImage", "feMerge", "feMergeNode", "feMorphology", "feOffset", "fePointLight", "feSpecularLighting", "feSpotLight", "feTile", "feTurbulence", "foreignObject", "glyphRef", "linearGradient", "radialGradient", "textPath"].map(e => [e.toLowerCase(), e]))
              , i = new Map(["definitionURL", "attributeName", "attributeType", "baseFrequency", "baseProfile", "calcMode", "clipPathUnits", "diffuseConstant", "edgeMode", "filterUnits", "glyphRef", "gradientTransform", "gradientUnits", "kernelMatrix", "kernelUnitLength", "keyPoints", "keySplines", "keyTimes", "lengthAdjust", "limitingConeAngle", "markerHeight", "markerUnits", "markerWidth", "maskContentUnits", "maskUnits", "numOctaves", "pathLength", "patternContentUnits", "patternTransform", "patternUnits", "pointsAtX", "pointsAtY", "pointsAtZ", "preserveAlpha", "preserveAspectRatio", "primitiveUnits", "refX", "refY", "repeatCount", "repeatDur", "requiredExtensions", "requiredFeatures", "specularConstant", "specularExponent", "spreadMethod", "startOffset", "stdDeviation", "stitchTiles", "surfaceScale", "systemLanguage", "tableValues", "targetX", "targetY", "textLength", "viewBox", "viewTarget", "xChannelSelector", "yChannelSelector", "zoomAndPan"].map(e => [e.toLowerCase(), e]))
        },
        6498: function(e, t, r) {
            r.d(t, {
                A: () => c
            ...
            var n = r(2743)
              , i = r(8466)
              , a = r(8832);
            let s = new Set(["style", "script", "xmp", "iframe", "noembed", "noframes", "plaintext", "noscript"]);
            function o(e) {
                return e.replace(/"/g, "&quot;")
            }
              ...
              , c = function e(t, r={}) {
                ...
                for (let t = 0; t < c.length; t++)
                    h += function(t, r) {
                        ...
                        case n.KB:
                            return p = t,
                            `<![CDATA[${p.children[0].data}]]>`;
                        case n.eF:
                        case n.OF:
                        case n.vw:
                            return function(t, r) {
                                var n;
                                "foreign" === r.xmlMode && (t.name = null != (n = a.H.get(t.name)) ? n : t.name,
                                t.parent && u.has(t.parent.name) && (r = {
                                    ...r,
                                    xmlMode: !1
                                })),
                                !r.xmlMode && d.has(t.name) && (r = {
                                    ...r,
                                    xmlMode: "foreign"
                                });
                                let s = `<${t.name}`
                                  , c = function(e, t) {
                                    ...
                                    if (!e)
                                        return;
                                    let n = (null != (r = t.encodeEntities) ? r : t.decodeEntities) === !1 ? o : t.xmlMode || "utf8" !== t.encodeEntities ? i.WY : i.Gj;
                                    return Object.keys(e).map(r => {
                                        var i, s;
                                        let o = null != (i = e[r]) ? i : "";
                                        return ("foreign" === t.xmlMode && (r = null != (s = a.L.get(r)) ? s : r),
                                        t.emptyAttrs || t.xmlMode || "" !== o) ? `${r}="${n(o)}"` : r
                                    }
                                    ).join(" ")
                                }(t.attribs, r);
                                return c && (s += ` ${c}`),
                                0 === t.children.length && (r.xmlMode ? !1 !== r.selfClosingTags : r.selfClosingTags && l.has(t.name)) ? (r.xmlMode || (s += " "),
                                s += "/>") : (s += ">",
                                t.children.length > 0 && (s += e(t.children, r)),
                                (r.xmlMode || !l.has(t.name)) && (s += `</${t.name}>`)),
                                s
                            }(t, r);
                        case n.EY:
                            return function(e, t) {
                                var r;
                                let n = e.data || "";
                                return (null != (r = t.encodeEntities) ? r : t.decodeEntities) === !1 || !t.xmlMode && e.parent && s.has(e.parent.name) || (n = t.xmlMode || "utf8" !== t.encodeEntities ? (0,
                                i.WY)(n) : (0,
                                i.X1)(n)),
                                n
                            }(t, r)
        ...
        6072: function(e, t, r) {
            ...
            class h extends c {
                constructor(e, t, r=[], i="script" === e ? n.RJ.Script : "style" === e ? n.RJ.Style : n.RJ.Tag) {
                    super(r),
                    this.name = e,
                    this.attribs = t,
                    this.type = i
        ...
        2146: function(e, t, r) {
            ...
            let i = new Map([[0, 65533], [128, 8364], [130, 8218], [131, 402], [132, 8222], [133, 8230], [134, 8224], [135, 8225], [136, 710], [137, 8240], [138, 352], [139, 8249], [140, 338], [142, 381], [145, 8216], [146, 8217], [147, 8220], [148, 8221], [149, 8226], [150, 8211], [151, 8212], [152, 732], [153, 8482], [154, 353], [155, 8250], [156, 339], [158, 382], [159, 376]])
              , a = null != (n = String.fromCodePoint) ? n : function(e) {
                let t = "";
        ...
        2990: function(e, t, r) {
            ...
            var n, i, a, s, o, l, c, u, d = r(7259), h = r(5949), p = r(2146);
            function f(e) {
            ...
            (a = c || (c = {}))[a.EntityStart = 0] = "EntityStart",
            ...
            class g {
                ...
                write(e, t) {
                    ...
                    case c.EntityStart:
                        if (e.charCodeAt(t) === o.NUM)
                            return this.state = c.NumericStart,
                            this.consumed += 1,
                            this.stateNumericStart(e, t + 1);
                        return this.state = c.NamedEntity,
                ...
                stateNumericStart(e, t) {
                    return t >= e.length ? -1 : (32 | e.charCodeAt(t)) === o.LOWER_X ? (this.state = c.NumericHex,
                    this.consumed += 1,
                    this.stateNumericHex(e, t + 1)) : (this.state = c.NumericDecimal,
                    this.stateNumericDecimal(e, t))
                }
                addToNumericResult(e, t, r, n) {
                    if (t !== r) {
                        let i = r - t;
                        this.result = this.result * Math.pow(n, i) + Number.parseInt(e.substr(t, i), n),
                        this.consumed += i
                    }
                }
                stateNumericHex(e, t) {
                    ...
                    for (; t < e.length; ) {
                        ...
                        if (!f(i) && (!((n = i) >= o.UPPER_A) || !(n <= o.UPPER_F)) && (!(n >= o.LOWER_A) || !(n <= o.LOWER_F)))
                            return this.addToNumericResult(e, r, t, 16),
                ...
                emitNumericEntity(e, t) {
                    var r;
                    if (this.consumed <= t)
                        return null == (r = this.errors) || r.absenceOfDigitsInNumericCharacterReference(this.consumed),
                        0;
                    if (e === o.SEMI)
                        this.consumed += 1;
                    ...
                    p.y6)(this.result), this.consumed),
                    this.errors && (e !== o.SEMI && this.errors.missingSemicolonAfterCharacterReference(),
                ...
                stateNamedEntity(e, t) {
                    ...
                    this.excess++) {
                        ...
                        if (this.treeIndex = function(e, t, r, n) {
                            ...
                            return -1
                        }(r, n, this.treeIndex + Math.max(1, i), a),
                        this.treeIndex < 0)
                            return 0 === this.result || this.decodeMode === u.Attribute && (0 === i || function(e) {
                                var t;
                        ...
                        if (0 != (i = ((n = r[this.treeIndex]) & l.VALUE_LENGTH) >> 14)) {
                            ...
                            this.decodeMode !== u.Strict && (this.result = this.treeIndex,
                ...
                emitNamedEntityData(e, t, r) {
                    ...
                    case c.NumericStart:
                        return null == (e = this.errors) || e.absenceOfDigitsInNumericCharacterReference(this.consumed),
                        0;
                    case c.EntityStart:
                        return 0
                    }
        ...
        747: function(e, t, r) {
            ...
            let n = /["$&'<>\u0080-\uFFFF]/g
              , i = new Map([[34, "&quot;"], [38, "&amp;"], [39, "&apos;"], [60, "&lt;"], [62, "&gt;"]])
              , a = null == String.prototype.codePointAt ? (e, t) => (64512 & e.charCodeAt(t)) == 55296 ? (e.charCodeAt(t) - 55296) * 1024 + e.charCodeAt(t + 1) - 56320 + 65536 : e.charCodeAt(t) : (e, t) => e.codePointAt(t);
            function s(e) {
                let t, r = "", s = 0;
                for (; null !== (t = n.exec(e)); ) {
                    let {index: o} = t
                      , l = e.charCodeAt(o)
                      , c = i.get(l);
                    void 0 === c ? (r += `${e.substring(s, o)}&#x${a(e, o).toString(16)};`,
                    s = n.lastIndex += Number((64512 & l) == 55296)) : (r += e.substring(s, o) + c,
                    s = o + 1)
                }
                return r + e.substr(s)
            }
            ...
            let l = o(/["&\u00A0]/g, new Map([[34, "&quot;"], [38, "&amp;"], [160, "&nbsp;"]]))
              , c = o(/[&<>\u00A0]/g, new Map([[38, "&amp;"], [60, "&lt;"], [62, "&gt;"], [160, "&nbsp;"]]))
        },
        7259: function(e, t, r) {
            r.d(t, {
                q: () => n
        ...
        4645: function(e, t, r) {
            ...
            class g {
                constructor(e, t={}) {
                    ...
                    this.lowerCaseTagNames = null != (r = t.lowerCaseTags) ? r : this.htmlMode,
                    this.lowerCaseAttributeNames = null != (i = t.lowerCaseAttributeNames) ? i : this.htmlMode,
                    this.recognizeSelfClosing = null != (a = t.recognizeSelfClosing) ? a : !this.htmlMode,
                    this.tokenizer = new (null != (s = t.Tokenizer) ? s : n.A)(this.options,this),
                    this.foreignContext = [!this.htmlMode],
                    null == (l = (o = this.cbs).onparserinit) || l.call(o, this)
                }
                ontext(e, t) {
                    var r, n;
                ...
                ontextentity(e, t) {
                    var r, n;
                    this.endIndex = t - 1,
                    null == (n = (r = this.cbs).ontext) || n.call(r, (0,
                    i.MK)(e)),
                    this.startIndex = t
                }
                isVoidElement(e) {
                ...
                emitOpenTag(e) {
                    ...
                    this.tagname = e;
                    let a = this.htmlMode && u.get(e);
                    if (a)
                        for (; this.stack.length > 0 && a.has(this.stack[0]); ) {
                            let e = this.stack.shift();
                            null == (r = (t = this.cbs).onclosetag) || r.call(t, e, !0)
                        }
                    !this.isVoidElement(e) && (this.stack.unshift(e),
                    this.htmlMode && (h.has(e) ? this.foreignContext.unshift(!0) : p.has(e) && this.foreignContext.unshift(!1))),
                ...
                endOpenTag(e) {
                    ...
                    this.attribs && (null == (r = (t = this.cbs).onopentag) || r.call(t, this.tagname, this.attribs, e),
                    this.attribs = null),
                ...
                onclosetag(e, t) {
                    ...
                    if (this.lowerCaseTagNames && (u = u.toLowerCase()),
                    this.htmlMode && (h.has(u) || p.has(u)) && this.foreignContext.shift(),
                    this.isVoidElement(u))
                        this.htmlMode && "br" === u && (null == (a = (i = this.cbs).onopentagname) || a.call(i, "br"),
                        null == (o = (s = this.cbs).onopentag) || o.call(s, "br", {}, !0),
                        ...
                        if (-1 !== e)
                            for (let t = 0; t <= e; t++) {
                                ...
                                null == (n = (r = this.cbs).onclosetag) || n.call(r, i, t !== e)
                            }
                        else
                            this.htmlMode && "p" === u && (this.emitOpenTag("p"),
                ...
                onselfclosingtag(e) {
                    this.endIndex = e,
                    this.recognizeSelfClosing || this.foreignContext[0] ? (this.closeCurrentTag(!1),
                ...
                closeCurrentTag(e) {
                    ...
                    let n = this.tagname;
                    this.endOpenTag(e),
                    this.stack[0] === n && (null == (r = (t = this.cbs).onclosetag) || r.call(t, n, !e),
                    this.stack.shift())
                }
                onattribname(e, t) {
                    this.startIndex = e;
                ...
                onattribend(e, t) {
                    var r, i;
                    this.endIndex = t,
                    null == (i = (r = this.cbs).onattribute) || i.call(r, this.attribname, this.attribvalue, e === n.X.Double ? '"' : e === n.X.Single ? "'" : e === n.X.NoValue ? void 0 : null),
                ...
                getInstructionName(e) {
                    ...
                    return this.lowerCaseTagNames && (r = r.toLowerCase()),
                    r
                }
                ondeclaration(e, t) {
                    this.endIndex = t;
                ...
                oncomment(e, t, r) {
                    var n, i, a, s;
                    this.endIndex = t,
                    null == (i = (n = this.cbs).oncomment) || i.call(n, this.getSlice(e, t - r)),
                    null == (s = (a = this.cbs).oncommentend) || s.call(a),
                    this.startIndex = t + 1
                }
                oncdata(e, t, r) {
                    var n, i, a, s, o, l, c, u, d, h;
                    this.endIndex = t;
                    let p = this.getSlice(e, t - r);
                    !this.htmlMode || this.options.recognizeCDATA ? (null == (i = (n = this.cbs).oncdatastart) || i.call(n),
                    null == (s = (a = this.cbs).ontext) || s.call(a, p),
                    null == (l = (o = this.cbs).oncdataend) || l.call(o)) : (null == (u = (c = this.cbs).oncomment) || u.call(c, `[CDATA[${p}]]`),
        ...
        5645: function(e, t, r) {
            ...
            class p {
                constructor({xmlMode: e=!1, decodeEntities: t=!0}, r) {
                    ...
                    this.entityDecoder = new c.Wf(e ? c.sr : c.qN, (e, t) => this.emitCodePoint(e, t))
                }
                reset() {
                    this.state = o.Text,
                    this.buffer = "",
                ...
                stateText(e) {
                    e === s.Lt || !this.decodeEntities && this.fastForwardTo(s.Lt) ? (this.index > this.sectionStart && this.cbs.ontext(this.sectionStart, this.index),
                    this.state = o.BeforeTagName,
                    this.sectionStart = this.index) : this.decodeEntities && e === s.Amp && this.startEntity()
                }
                ...
                stateInSpecialTag(e) {
                    ...
                    (32 | e) === this.currentSequence[this.sequenceIndex] ? this.sequenceIndex += 1 : 0 === this.sequenceIndex ? this.currentSequence === h.TitleEnd ? this.decodeEntities && e === s.Amp && this.startEntity() : this.fastForwardTo(s.Lt) && (this.sequenceIndex = 1) : this.sequenceIndex = Number(e === s.Lt)
                }
                stateCDATASequence(e) {
                    e === h.Cdata[this.sequenceIndex] ? ++this.sequenceIndex === h.Cdata.length && (this.state = o.InCommentLike,
                    this.currentSequence = h.CdataEnd,
                    this.sequenceIndex = 0,
                    this.sectionStart = this.index + 1) : (this.sequenceIndex = 0,
                    this.state = o.InDeclaration,
                ...
                stateInCommentLike(e) {
                    e === this.currentSequence[this.sequenceIndex] ? ++this.sequenceIndex === this.currentSequence.length && (this.currentSequence === h.CdataEnd ? this.cbs.oncdata(this.sectionStart, this.index, 2) : this.cbs.oncomment(this.sectionStart, this.index, 2),
                    this.sequenceIndex = 0,
                    this.sectionStart = this.index + 1,
                    this.state = o.Text) : 0 === this.sequenceIndex ? this.fastForwardTo(this.currentSequence[0]) && (this.sequenceIndex = 1) : e !== this.currentSequence[this.sequenceIndex - 1] && (this.sequenceIndex = 0)
                }
                isTagStartChar(e) {
                ...
                startSpecial(e, t) {
                    ...
                    this.state = o.SpecialStartSequence
                }
                stateBeforeTagName(e) {
                    if (e === s.ExclamationMark)
                        this.state = o.BeforeDeclaration,
                        this.sectionStart = this.index + 1;
                    else if (e === s.Questionmark)
                        this.state = o.InProcessingInstruction,
                        this.sectionStart = this.index + 1;
                    else if (this.isTagStartChar(e)) {
                        let t = 32 | e;
                        this.sectionStart = this.index,
                        this.xmlMode ? this.state = o.InTagName : t === h.ScriptEnd[2] ? this.state = o.BeforeSpecialS : t === h.TitleEnd[2] || t === h.XmpEnd[2] ? this.state = o.BeforeSpecialT : this.state = o.InTagName
                    } else
                        e === s.Slash ? this.state = o.BeforeClosingTagName : (this.state = o.Text,
                        this.stateText(e))
                }
                stateInTagName(e) {
                    d(e) && (this.cbs.onopentagname(this.sectionStart, this.index),
                    this.sectionStart = -1,
                    this.state = o.BeforeAttributeName,
                    this.stateBeforeAttributeName(e))
                }
                stateBeforeClosingTagName(e) {
                    u(e) || (e === s.Gt ? this.state = o.Text : (this.state = this.isTagStartChar(e) ? o.InClosingTagName : o.InSpecialComment,
                    this.sectionStart = this.index))
                }
                stateInClosingTagName(e) {
                    (e === s.Gt || u(e)) && (this.cbs.onclosetag(this.sectionStart, this.index),
                    this.sectionStart = -1,
                    this.state = o.AfterClosingTagName,
                    this.stateAfterClosingTagName(e))
                }
                stateAfterClosingTagName(e) {
                    (e === s.Gt || this.fastForwardTo(s.Gt)) && (this.state = o.Text,
                    this.sectionStart = this.index + 1)
                }
                stateBeforeAttributeName(e) {
                    e === s.Gt ? (this.cbs.onopentagend(this.index),
                    this.isSpecial ? (this.state = o.InSpecialTag,
                    this.sequenceIndex = 0) : this.state = o.Text,
                    this.sectionStart = this.index + 1) : e === s.Slash ? this.state = o.InSelfClosingTag : u(e) || (this.state = o.InAttributeName,
                    this.sectionStart = this.index)
                }
                stateInSelfClosingTag(e) {
                    e === s.Gt ? (this.cbs.onselfclosingtag(this.index),
                    this.state = o.Text,
                    this.sectionStart = this.index + 1,
                    this.isSpecial = !1) : u(e) || (this.state = o.BeforeAttributeName,
                    this.stateBeforeAttributeName(e))
                }
                stateInAttributeName(e) {
                    (e === s.Eq || d(e)) && (this.cbs.onattribname(this.sectionStart, this.index),
                    this.sectionStart = this.index,
                    this.state = o.AfterAttributeName,
                    this.stateAfterAttributeName(e))
                }
                stateAfterAttributeName(e) {
                    e === s.Eq ? this.state = o.BeforeAttributeValue : e === s.Slash || e === s.Gt ? (this.cbs.onattribend(l.NoValue, this.sectionStart),
                    this.sectionStart = -1,
                    this.state = o.BeforeAttributeName,
                    this.stateBeforeAttributeName(e)) : u(e) || (this.cbs.onattribend(l.NoValue, this.sectionStart),
                    this.state = o.InAttributeName,
                    this.sectionStart = this.index)
                }
                stateBeforeAttributeValue(e) {
                    e === s.DoubleQuote ? (this.state = o.InAttributeValueDq,
                    this.sectionStart = this.index + 1) : e === s.SingleQuote ? (this.state = o.InAttributeValueSq,
                    this.sectionStart = this.index + 1) : u(e) || (this.sectionStart = this.index,
                    this.state = o.InAttributeValueNq,
                ...
                handleInAttributeValue(e, t) {
                    ...
                    this.sectionStart = -1,
                    this.cbs.onattribend(t === s.DoubleQuote ? l.Double : l.Single, this.index + 1),
                    this.state = o.BeforeAttributeName) : this.decodeEntities && e === s.Amp && this.startEntity()
                }
                ...
                stateInAttributeValueNoQuotes(e) {
                    u(e) || e === s.Gt ? (this.cbs.onattribdata(this.sectionStart, this.index),
                    this.sectionStart = -1,
                    this.cbs.onattribend(l.Unquoted, this.index),
                    this.state = o.BeforeAttributeName,
                    this.stateBeforeAttributeName(e)) : this.decodeEntities && e === s.Amp && this.startEntity()
                }
                stateBeforeDeclaration(e) {
                    e === s.OpeningSquareBracket ? (this.state = o.CDATASequence,
                    this.sequenceIndex = 0) : this.state = e === s.Dash ? o.BeforeComment : o.InDeclaration
                }
                stateInDeclaration(e) {
                    (e === s.Gt || this.fastForwardTo(s.Gt)) && (this.cbs.ondeclaration(this.sectionStart, this.index),
                    this.state = o.Text,
                    this.sectionStart = this.index + 1)
                }
                stateInProcessingInstruction(e) {
                    (e === s.Gt || this.fastForwardTo(s.Gt)) && (this.cbs.onprocessinginstruction(this.sectionStart, this.index),
                    this.state = o.Text,
                    this.sectionStart = this.index + 1)
                }
                stateBeforeComment(e) {
                    e === s.Dash ? (this.state = o.InCommentLike,
                    this.currentSequence = h.CommentEnd,
                    this.sequenceIndex = 2,
                    this.sectionStart = this.index + 1) : this.state = o.InDeclaration
                }
                stateInSpecialComment(e) {
                    (e === s.Gt || this.fastForwardTo(s.Gt)) && (this.cbs.oncomment(this.sectionStart, this.index, 0),
                    this.state = o.Text,
                    this.sectionStart = this.index + 1)
                }
                stateBeforeSpecialS(e) {
                    let t = 32 | e;
                    t === h.ScriptEnd[3] ? this.startSpecial(h.ScriptEnd, 4) : t === h.StyleEnd[3] ? this.startSpecial(h.StyleEnd, 4) : (this.state = o.InTagName,
                    this.stateInTagName(e))
                }
                ...
                startEntity() {
                    ...
                    this.state = o.InEntity,
                    this.entityStart = this.index,
                    this.entityDecoder.startEntity(this.xmlMode ? c.FJ.Strict : this.baseState === o.Text || this.baseState === o.InSpecialTag ? c.FJ.Legacy : c.FJ.Attribute)
                }
                stateInEntity() {
                    let e = this.entityDecoder.write(this.buffer, this.index - this.offset);
                    e >= 0 ? (this.state = this.baseState,
                    0 === e && (this.index = this.entityStart)) : this.index = this.offset + this.buffer.length - 1
                }
                cleanup() {
                    this.running && this.sectionStart !== this.index && (this.state === o.Text || this.state === o.InSpecialTag && 0 === this.sequenceIndex ? (this.cbs.ontext(this.sectionStart, this.index),
                    this.sectionStart = this.index) : (this.state === o.InAttributeValueDq || this.state === o.InAttributeValueSq || this.state === o.InAttributeValueNq) && (this.cbs.onattribdata(this.sectionStart, this.index),
                    this.sectionStart = this.index))
                }
                shouldContinue() {
                ...
                finish() {
                    this.state === o.InEntity && (this.entityDecoder.end(),
                ...
                emitCodePoint(e, t) {
                    this.baseState !== o.Text && this.baseState !== o.InSpecialTag ? (this.sectionStart < this.entityStart && this.cbs.onattribdata(this.sectionStart, this.entityStart),
                    this.sectionStart = this.entityStart + t,
                    this.index = this.sectionStart - 1,
                    this.cbs.onattribentity(e)) : (this.sectionStart < this.entityStart && this.cbs.ontext(this.sectionStart, this.entityStart),
                    this.sectionStart = this.entityStart + t,
                    this.index = this.sectionStart - 1,
        ...
        6570: function(e, t, r) {
            ...
            function h(e) {
                ...
                let t = function(e) {
                    ...
                    o(e, n || (n = [IDBDatabase, IDBObjectStore, IDBIndex, IDBCursor, IDBTransaction]))) ? new Proxy(e,d) : e
                }(e);
            ...
            let p = e => u.get(e);
            function f(e, t, {blocked: r, upgrade: n, blocking: i, terminated: a}={}) {
                let s = indexedDB.open(e, t)
                  , o = h(s);
                return n && s.addEventListener("upgradeneeded", e => {
                    n(h(s.result), e.oldVersion, e.newVersion, h(s.transaction), e)
                }
                ),
            ...
            function b(e, t) {
                ...
                let r = t.replace(/FromIndex$/, "")
                  , n = t !== r
                  , i = m.includes(r);
                if (!(r in (n ? IDBIndex : IDBObjectStore).prototype) || !(i || g.includes(r)))
                    return;
            ...
            let w = ["continue", "continuePrimaryKey", "advance"]
              , S = {}
              , v = new WeakMap
              , x = new WeakMap
              , E = {
                get(e, t) {
                    if (!w.includes(t))
                        return e[t];
                    let r = S[t];
                    return r || (r = S[t] = function(...e) {
                        v.set(this, x.get(this)[t](...e))
                    }
                    ),
                    r
                }
            ...
            async function *T(...e) {
                ...
                u.set(r, p(t)); t; )
                    yield r,
                    t = await (v.get(r) || t.continue()),
                    v.delete(r)
            }
            function k(e, t) {
                return t === Symbol.asyncIterator && o(e, [IDBIndex, IDBObjectStore, IDBCursor]) || "iterate" === t && o(e, [IDBIndex, IDBObjectStore])
            }
            d = {
                ...s = d,
                get: (e, t, r) => k(e, t) ? T : s.get(e, t, r),
                has: (e, t) => k(e, t) || s.has(e, t)
            }
        },
        1652: function(e, t, r) {
            r.d(t, {
        ...
        3907: function(e, t, r) {
            ...
            function a(e, t) {
                try {
                    ...
                    let e, t = (e = n.__externref_table_alloc(),
                    n.__wbindgen_export_2.set(e, r),
                    e);
                    n.__wbindgen_exn_store(t)
                }
            }
            let s = "undefined" != typeof TextDecoder ? new TextDecoder("utf-8",{
                ignoreBOM: !0,
                fatal: !0
            }) : {
                decode: () => {
            ...
            let o = null;
            function l() {
                return (null === o || 0 === o.byteLength) && (o = new Uint8Array(n.memory.buffer)),
                o
            }
            function c(e, t) {
                return e >>>= 0,
                s.decode(l().subarray(e, e + t))
            }
            let u = 0
            ...
            function p(e, t, r) {
                if (void 0 === r) {
                    let r = d.encode(e)
                      , n = t(r.length, 1) >>> 0;
                    return l().subarray(n, n + r.length).set(r),
                    u = r.length,
                    n
                }
                let n = e.length
                ...
                if (s !== n) {
                    0 !== s && (e = e.slice(s)),
                    i = r(i, n, n = s + 3 * e.length, 1) >>> 0;
                    let t = h(e, l().subarray(i + s, i + n));
                    s += t.written,
                    i = r(i, n, s, 1) >>> 0
                }
                return u = s,
            ...
            let f = null;
            function g() {
                return (null === f || !0 === f.buffer.detached || void 0 === f.buffer.detached && f.buffer !== n.memory.buffer) && (f = new DataView(n.memory.buffer)),
                f
            }
            function m(e) {
                let t = n.__wbindgen_export_2.get(e);
                return n.__externref_table_dealloc(e),
                t
            }
            ...
            class b {
                ...
                rewrite_js(e, t, r, i) {
                    let a = p(e, n.__wbindgen_malloc, n.__wbindgen_realloc)
                      , s = u
                      , o = p(t, n.__wbindgen_malloc, n.__wbindgen_realloc)
                      , l = u
                      , c = p(r, n.__wbindgen_malloc, n.__wbindgen_realloc)
                      , d = u
                      , h = n.rewriter_rewrite_js(this.__wbg_ptr, a, s, o, l, c, d, i);
                    if (h[2])
                        throw m(h[1]);
                    return m(h[0])
                }
                rewrite_js_bytes(e, t, r, i) {
                    let a, s = (a = (0,
                    n.__wbindgen_malloc)(+e.length, 1) >>> 0,
                    l().set(e, a / 1),
                    u = e.length,
                    a), o = u, c = p(t, n.__wbindgen_malloc, n.__wbindgen_realloc), d = u, h = p(r, n.__wbindgen_malloc, n.__wbindgen_realloc), f = u, g = n.rewriter_rewrite_js_bytes(this.__wbg_ptr, s, o, c, d, h, f, i);
                    if (g[2])
                        throw m(g[1]);
                    return m(g[0])
                }
            ...
            function S() {
                ...
                e.wbg.__wbg_scramtag_3a255d78b157986d = function(e) {
                    let t = p((0,
                    i.N)(), n.__wbindgen_malloc, n.__wbindgen_realloc)
                      , r = u;
                    g().setInt32(e + 4, r, !0),
                    g().setInt32(e + 0, t, !0)
                }
                ...
                e.wbg.__wbindgen_string_get = function(e, t) {
                    ...
                    var i = null == r ? 0 : p(r, n.__wbindgen_malloc, n.__wbindgen_realloc)
                      , a = u;
                    g().setInt32(e + 4, a, !0),
                    g().setInt32(e + 0, i, !0)
                }
            ...
            function x(e) {
                ...
                v(new WebAssembly.Instance(e,t), e)
            }
            async function E(e) {
                if (void 0 !== n)
                    return n;
